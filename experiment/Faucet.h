...
public:
		...
		m_lifetimeRandomizer(k_particleLifetimeMin, k_particleLifetimeMax)
	{
        ...
        shape.SetAsBox(50, 1, b2Vec2(0, 0), 0.0);
		ground->CreateFixture(&shape, 0.0f);

        // LHS of pressure chamber
        b2Vec2 chamber[5] = {
                b2Vec2(-0.5f, 10.0f),
                b2Vec2(-50.0f, 10.0f),
                b2Vec2(-50.0f, 0.0f),
...
/*
        ...
        */
		// Initialize the particle emitter.
		{
			...
			m_emitter.SetColor(b2ParticleColor(0xe6, 0x1f, 0x03, 255));
	...
	void Step(Settings* settings)
	{
		...
		b2ParticleColor color(0xe6, 0x1f, 0x03, 255);
...
const float32 Faucet::k_particleLifetimeMax = 120.0f;
