...
void ImApp::BaseDraw() {
    ...
    // Does all the imgui drawing, which places things on ImGui's render list,
    // which are drawn to the display by the Render call.
    Draw();

    // Perform any openGL drawing wanted
    GLDraw();
